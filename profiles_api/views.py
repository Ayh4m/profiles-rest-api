...
from rest_framework.permissions import IsAuthenticatedOrReadOnly  # see IsAuthenticated to make it private API (Just Authenticated User Can "See", Create, Update)
...
class HelloViewSet(viewsets.ViewSet):
    ...
    def list(self, request):
        ...
        a_viewset = [
            ...
            "Is mapped Automatically to URLs using Routers",
